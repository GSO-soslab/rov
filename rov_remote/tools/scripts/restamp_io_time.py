...
# ------------------------------------------------------------------------------
# Function : restamp ros bagfile using IO time, replace the header timestamp and rosbag time
#
# Usage    : python restamp_bag.py -i inbag.bag -o outbag.bag
# ------------------------------------------------------------------------------

# input bag file and topic name
# match 'calib' with 'data': using header timestamp
# replace header timestamp and rosbag time
